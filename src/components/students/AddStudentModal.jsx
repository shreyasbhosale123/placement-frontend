...
import { X, Loader2, UserPlus, Pencil, AlertCircle } from "lucide-react";
import api from "../../services/api";

const INITIAL_FORM = { name: "", email: "", cgpa: "" };
const INITIAL_ERRORS = { name: "", email: "", cgpa: "" };
    ...
    >
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl shadow-slate-200/80 border border-slate-100 animate-[fadeSlideUp_0.18s_ease-out]">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-indigo-50">
              {isEdit
                ...
                : <UserPlus size={18} className="text-indigo-600" strokeWidth={1.8} />
              }
            </div>
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                {isEdit ? "Update the student's details" : "Fill in the details below"}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="px-6 py-5 flex flex-col gap-4">
          ...
          <Field label="CGPA" id="cgpa" error={errors.cgpa}>
            <input
              id="cgpa"
              name="cgpa"
              type="number"
